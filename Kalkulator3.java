  ...
  //   System.out.println(s);   
    ...
    public static String calc(String input) throws Exception{
       ...
       if(s2.length()>1){
        ...
        if(s1.matches("(III)+|(IV)+|V+|(VI)+|(VII)+|(VIII)+|(IX)+|(XXX)+|(XX)+|X+|L+|C+|D+|M+|II+|I+")&&
         ...
         for(Roma r5:r3){
             ...
             if(Integer.parseInt(r5.getS())==0){
                 throw new ExRes0_Roma("throws Exception // В римских числах результат вычисления не может быть 0 !");
             }
             }
         }
        }
        ...
        if((i<1)||(i>10)){
            throw new ExMenshe1Bolshe10("throws Exception // Результат не может быть меньше 1 или больше 10 !");
        }
        return "Output: \n" + ss ;
    }
}
...
O("0"), I("1"), II("2"), III("3"), IV("4"), V("5"), VI("6"), VII("7"), VIII("8"), IX("9"), X("10"),
 ...
 XXX("30"), XX("20"), L("50"), C("100"), D("500"), M("1000");
